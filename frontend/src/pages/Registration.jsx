...
//             setLoading(false)
//             // 1. Pehle Success Toast dikhayenge
//             toast.success("Registration Successful! Please Login to continue.")
            
//             // 2. Direct Home pe bhejane ki jagah Login page pe redirect karenge
//             navigate("/login")
...
//             toast.success("Google Registration Successful! Now Login.")
//             navigate("/login")
...
//                 <span className='text-[16px]'>Welcome to DoShopAI, Create your account</span>
//             </div>
...
//                             {!show && <IoEyeOutline className='w-[20px] h-[20px] cursor-pointer absolute right-[5%] top-[30%]' onClick={() => setShow(prev => !prev)} />}
//                             {show && <IoEye className='w-[20px] h-[20px] cursor-pointer absolute right-[5%] top-[30%]' onClick={() => setShow(prev => !prev)} />}
//                         </div>
            ...
            <div className='w-full min-h-screen bg-[#0a0a0b] bg-[radial-gradient(circle_at_center,_#1a3a42_0%,_#0a0a0b_60%,_#0a0a0b_100%)] animate-bg-glow text-white flex flex-col items-center overflow-x-hidden'>
                ...
                <div className='flex-1 flex flex-col items-center justify-center w-full px-4 pb-12 mt-[-40px]'>
                    <div className='text-center mb-10'>
                        <h2 className='text-4xl md:text-5xl font-extrabold mb-3 tracking-tighter bg-gradient-to-b from-white to-gray-400 bg-clip-text text-transparent'>Register</h2>
                        <p className='text-gray-400 text-sm md:text-base'>Create your <span className='text-blue-400'>DoCart</span> account and start shopping.</p>
                    </div>

                    {/* Glassmorphism Card */}
                    <div className='max-w-[480px] w-full bg-white/5 border border-white/10 backdrop-blur-2xl rounded-3xl p-8 lg:p-10 shadow-[0_20px_50px_rgba(0,0,0,0.6)] transition-all hover:border-white/20'>
                        ...
                        <form onSubmit={handleSignup} className='flex flex-col gap-5'>
                            ...
                            <div className='flex items-center gap-4'>
                                ...
                                <span className='text-[10px] text-gray-600 uppercase tracking-widest font-bold'>or use email</span>
                                <div className='flex-1 h-[1px] bg-white/10'></div>
                            </div>
